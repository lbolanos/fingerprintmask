...
def dict_to_tf_example(data,
  ...
  if 'object' in data:
    for obj in data['object']:
      ...
      if not faces_only:
        #img2 = PIL.Image.fromarray(mask_np)
        #img2.save("testBef.bmp", format='BMP')
        mask_remapped = (mask_np > 0).astype(np.uint8) #* 255
        #img3 = PIL.Image.fromarray(mask_remapped)
        #img3.save("testAft.bmp", format='BMP')
...
def main(_):
  logging.basicConfig(filename='createTF.log', level=logging.DEBUG)
